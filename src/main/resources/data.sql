...
/*
After changes to payment information and accepted payment information
...
INSERT INTO marke(id, name, category_id, marken_pic_url) values(0, 'Tokyo Mafia', 1, 'https://i0.wp.com/twinfinite.net/wp-content/uploads/2020/11/yakuzalikeadragon-kiryu1.jpg?fit=1000%2C563&ssl=1');
INSERT INTO marke(id, name, category_id, marken_pic_url) values(0, 'Porsche', 2, 'https://pngimg.com/uploads/porsche_logo/porsche_logo_PNG1.png');
INSERT INTO marke(id, name, category_id, marken_pic_url) values(0, 'Judas Priest', 3, 'https://www.pikpng.com/pngl/b/490-4900168_shedding-the-light-and-darkness-on-this-epic.png');

INSERT INTO advertisement(id, description, price, title, featured, featured_description, featured_title, featured_picture_url, marke_id, seller_id)
values (0, 'Kiryu beschützt dich vor bösen Leuten', 50, 'KAZUMA KIRYU', true, 'Jetzt Kiryu als Bodygurd engagieren', 'Bodyguard: Kazuma Kiryu', 'https://twinfinite.net/wp-content/uploads/2020/01/Yakuza-7-1.jpg', 1, 1);

INSERT INTO advertisement(id, description, price, title, featured, featured_description, featured_title, featured_picture_url, marke_id, seller_id)
values (0, 'Die Kids im Internet stehen voll drauf', 50, 'Porsche Cayman S', true, 'Porsche Cayman S zu Verkaufen', 'Angebot: Porsche Cayman S', 'https://imgr1.auto-motor-und-sport.de/Porsche-718-PDK-169FullWidth-3bb8077e-1701473.jpg', 2, 2);
...
INSERT INTO cart_item(id, user_id, advertisement_id, quantity) values (0, 2, 3, 1);
INSERT INTO cart_item(id, user_id, advertisement_id, quantity) values (0, 1, 5, 2);

INSERT INTO payment_method(id, name) values (0, 'Credit Card');
INSERT INTO payment_method(id, name) values (0, 'Pay Pal');
INSERT INTO payment_method(id, name) values (0, 'Bitcoin');

INSERT INTO accepted_payment_method(id, payment_method_id, seller_id) values (0, 1, 1);
INSERT INTO accepted_payment_method(id, payment_method_id, seller_id) values (0, 2, 1);
INSERT INTO accepted_payment_method(id, payment_method_id, seller_id) values (0, 3, 1);
INSERT INTO accepted_payment_method(id, payment_method_id, seller_id) values (0, 1, 2);
INSERT INTO accepted_payment_method(id, payment_method_id, seller_id) values (0, 2, 2);

INSERT INTO payment_information (id, additional_information1, additional_information2, address, payment_method_id, seller_id, accepted_payment_method_id)
VALUES(0, 'Placeholder1', 'Placeholder2', 'ASKLDJASKL478676789D', 1, 1, 1);

INSERT INTO payment_information (id, additional_information1, additional_information2, address, payment_method_id, seller_id, accepted_payment_method_id)
VALUES(0, '', '', 'BITCASKLDJASKL478676789D', 2, 1, 2);

INSERT INTO payment_information (id, additional_information1, additional_information2, address, payment_method_id, seller_id, accepted_payment_method_id)
VALUES(0, 'Placeholder1', 'Placeholder2', 'sample@sample.com', 3, 1, 3);

INSERT INTO payment_information (id, additional_information1, additional_information2, address, payment_method_id, seller_id, accepted_payment_method_id)
VALUES(0, 'Placeholder1', 'Placeholder2', 'ASKLDJASKL478676789D', 1, 2, 4);

INSERT INTO payment_information (id, additional_information1, additional_information2, address, payment_method_id, seller_id, accepted_payment_method_id)
VALUES(0, 'Placeholder1', 'Placeholder2', 'ASKLDJASKL478676789D', 2, 2, 5);
